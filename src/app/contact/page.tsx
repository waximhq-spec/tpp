                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-100">
                  <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100/50">
                    <div className="flex items-center gap-2 text-slate-400 mb-1">
                      ...
                      <span className="text-[9px] font-bold uppercase text-slate-500">Total Installed Capacity</span>
                    </div>
                  ...
                  <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100/50">
                    <div className="flex items-center gap-2 text-slate-400 mb-1">
                      ...
                      <span className="text-[9px] font-bold uppercase text-slate-500">No. of Installations</span>
                    </div>
